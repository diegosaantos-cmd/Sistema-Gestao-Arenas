...
@section('title', 'Confirmar exclusão da quadra')
...
<div class="container py-4 painel">
    ...
    <h1 class="fw-bold mb-1">Excluir quadra — {{ $quadra->name }}</h1>
    ...
    <div class="alert alert-danger">
        A quadra será <strong>excluída</strong> (sai da sua gestão e dos agendamentos) e os
        agendamentos abaixo serão <strong>cancelados</strong>. O <strong>histórico de reservas
        é mantido</strong>. Informe o motivo (será aplicado a todos) e confirme.
    ...
    <form method="POST" action="{{ route('quadras.delete.confirm', $quadra) }}">
        @csrf
        ...
        <div class="mb-3" style="max-width: 600px;">
            ...
            <textarea name="motivo" class="form-control" rows="3" required
                      placeholder="Ex.: Quadra removida.">{{ $motivo ?? '' }}</textarea>
        </div>
        ...
        <div class="d-flex gap-2">
            ...
            <button type="submit" class="btn btn-danger">
                🗑️ Confirmar cancelamentos e excluir quadra
            </button>
        </div>
    </form>
